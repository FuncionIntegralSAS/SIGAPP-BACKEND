...
// import org.springframework.web.server.ResponseSta tusException;
...
// @InjectMocks
// private PersonalServiceImpl service; // Inyectamos el mock en el servicio
// real
...
// System.out.println("✅
// [buscarPorCriterios_FallaCuandoTodosLosParametrosSonNulos] Excepción
// validada: " + exception.getReason());
// }
...
// when(repository.buscarDinamica("Juan", null,
// null)).thenReturn(List.of(mockModel));

// // 2. Act (Ejecutar)
// List<PersonResponse> resultados = service.buscarPorCriterios("Juan", null,
// null);
...
// assertEquals("Juan Perez", response.getFullName()); // Verifica que concatenó
// bien
// assertEquals("DIV_ADMIN", response.getDivisionId());

// System.out.println("✅ [buscarPorCriterios_RetornaListaMapeadaCorrectamente]
// Mapeo de persona exitoso:");
// resultados.forEach(p -> System.out.println(" -> ID: " + p.getId() + " |
// Nombre: " + p.getFullName() + " | Div: " + p.getDivisionId()));
// }

// @Test
// void buscarPorCriterios_RetornaListaVacia() {
// when(repository.buscarDinamica("Pedro", null,
// null)).thenReturn(java.util.Collections.emptyList());

// List<PersonResponse> resultados = service.buscarPorCriterios("Pedro", null,
// null);

// assertNotNull(resultados);
// assertTrue(resultados.isEmpty());

// System.out.println("✅ [buscarPorCriterios_RetornaListaVacia] Manejo de lista
// vacía exitoso.");
// }
// }