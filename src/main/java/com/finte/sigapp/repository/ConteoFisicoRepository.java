...
public class ConteoFisicoRepository {
        ...
        public void generarConteoFisico(String empresa,
                ...
                log.info("Llamando a proGeneContFisi - Empresa: {}, Bodega: {}, Bodega Lógica: {} Artículo: {}, Fecha: {}, Verificar Existencia: {}",
                                empresa, bodega, bodegaLogica, articulo, fecha, verificarExistencia);

                // seteo parametros del procedimiento
        ...
        @Query(value = """
                        ...
                        FROM
                            CONTARBO a
                        JOIN
                            BODEGA b ON b.bodecodi = a.COABBODE
                        WHERE
                            a.COABESTA = 'ac'
                            AND a.COABDIEM = b.BODEEMPR
                            AND b.BODEEMPR = :empresa
                                            """, nativeQuery = true)
        List<BodegasConteoPendientes> buscarBodegasConConteo(@Param("empresa") String empresa);
